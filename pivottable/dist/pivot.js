  ...
  callWithJQuery(function ($) {
    ...
    pivotTableRenderer = function (pivotData, opts) {
      ...
      for (j in colAttrs) {
        ...
        c = colAttrs[j];
        /**
           * A linha a baixo foi inserida para ignorar as funções do 
           * http://localhost/joomla395/media/system/js/mootools-core.js?7c2c9102fc34267a8ca7f3ffbea8d980 que 
           * por algum motivo estavam sendo exibidas como conteúdo das colunas da tabela.
           */
        if (c.toString().match(/function/g)) continue;
      ...
      if (rowAttrs.length !== 0) {
        ...
        for (i in rowAttrs) {
          ...
          r = rowAttrs[i];
          /**
           * A linha de código a baixo foi inserida para ignorar as funções do 
           * http://localhost/joomla395/media/system/js/mootools-core.js?7c2c9102fc34267a8ca7f3ffbea8d980 que 
           * por algum motivo estavam sendo exibidas como conteúdo das linhas da tabela.
           */
          if (r.toString().match(/function/g)) continue;
          th = document.createElement("th");
          th.className = "pvtAxisLabel";
          th.textContent = r;
          tr.appendChild(th);
